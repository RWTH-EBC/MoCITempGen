...
def create_convert_aixlib(l_ibpsa_conv, dst, l_aixlib_conv):
    """
...
if __name__ == '__main__':
    ...
    if result is True:
        print(
            f'The latest aixlib conversion script {l_aixlib_conv} is up to date with IBPSA conversion script {l_ibpsa_conv}')
    if result is False:
        ...
        if file_new_conv is None:
            ...
            print(f'New Aixlib Conversion scrip was created: {file_new_conv}')
